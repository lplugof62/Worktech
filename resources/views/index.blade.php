...
@section('content')
<!-- Banner inicio-->
<div class=" text-gray-800" style="background-image: url('https://cdn.pixabay.com/photo/2015/09/05/21/14/macbook-925387_960_720.jpg'); background-repeat: no-repeat; background-size: cover;"  >
    <div class="flex h-screen">
        <div class="m-auto text-center">
            <h1 style="font-weight:bold; font-size: xx-large;" class="md:text-base text-gray-900 p-2 mb-10">Bienvenido a Worktech</h1>
            <a href="/" class="bg-transparent hover:bg-green-500 text-green-500 hover:text-white rounded shadow hover:shadow-lg py-2 px-4 border border-green-500 hover:border-transparent">
                Ver empleos</a>
        </div>
    </div>
</div>
