            ...
            <div class="bg-gray-200 text-gray-800 mx-10 rounded-md items-center border-2 border-blue-300 my-6">
                ...
                <div class="p-4">
                    <h2 class="text-2xl tracking-tight font-semibold">{{ $vacancy->title }}</h6>
                        ...
                        @if (Auth::guest())
                            <a class="grid" href="{{ route('login') }}">
                                <div
                                    class="bg-green-500 hover:bg-green-600 mt-5 text-white rounded-2xl py-1 w-36 place-self-center text-center  text-base">
                                    Aplicar</div>
                            </a>
                        @else
                            <a class="grid" href="{{ route('register') }}">
                                <div
                                    class="bg-green-500 hover:bg-green-600 mt-5 text-white rounded-2xl py-1 w-36 place-self-center text-center  text-base">
                                    Aplicar</div>
                            </a>
